...
const SingleReview = ({data, renderModal}) => (
  ...
  <div className={style.Singleoverreview} style={{backgroundColor: data.color}} onClick={()=>(renderModal(data))}>
    ...
    <div className= {style.Singletextreview}>{data.text}</div>
