...
const Votedata = ({ feature }) => (
        ...
        <tr className={style.list}>
                ...
                <td className={style.votetext}><svg className={style.svg} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" height="24px" width="24px"><path d={feature.Topic2path} ></path></svg>{feature.Topic2}</td>
                ...
                <td className={style.votetext}><svg className={style.svg}viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"height="24" width="24"><path d={feature.Topic3path} ></path></svg>{feature.Topic3}</td>
        </tr>
