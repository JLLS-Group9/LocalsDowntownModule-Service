...
const Votedata = ({ feature }) => (
        ...
        <div className={style.voterow}>
                ...
                <div className={style.votepercentage}>   <svg className={style.svg} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"  height={feature.Topic1size} width={feature.Topic1size}><path d={feature.pathlike1} fill={feature.pathlike1fill}  fill-rule='evenodd'></path></svg>{feature.like3}%</div>
                <div className={style.votetext}><svg className={style.voterow3}  height={feature.Topic3size} width={feature.Topic3size}  viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d={feature.Topic3path} fill={feature.Topic3fill}  fill-rule='evenodd' ></path></svg>{feature.Topic3}</div>
        </div>
